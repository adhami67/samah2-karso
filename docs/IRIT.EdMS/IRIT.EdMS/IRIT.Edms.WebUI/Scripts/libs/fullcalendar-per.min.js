...
var defaults = {
	...
	buttonText: {
	    prev: "<span class='fc-text-arrow' Style='font-size: 0.8em;font-family: FontAwesome;;font-weight: regular;'>ماه قبل</span>",
	    next: "<span class='fc-text-arrow' Style='font-size: 0.8em;font-family: FontAwesome'>ماه بعد</span>",
	    prevYear: "<span class='fc-text-arrow' Style='font-size: 0.8em;font-family: FontAwesome;font-weight: bold;'>سال قبل</span>",
	    nextYear: "<span class='fc-text-arrow' Style='font-size: 0.8em;font-family: FontAwesome;font-weight: bold;'>سال بعد</span>",
		today: 'today',
		month: 'month',
		week: 'week',
		day: 'day',
		...
		if (buttonStr) {
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					if (buttonName == 'title') {
					    e.append("<span class='fc-header-title'>" +
						    "<h2> <select>" +
