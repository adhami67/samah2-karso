...
namespace IRIT.EdMS.WebUI.Areas.Security.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : IRIT.EdMS.WebUI.Areas.Security.Controllers.AccountController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, IRIT.EdMS.Security.Model.ViewModel.Account.LoginViewModel model, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(IRIT.EdMS.Security.Model.ViewModel.Account.LoginViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        [NonAction]
        partial void RenderPhotoOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, long userId);

        [NonAction]
        public override System.Web.Mvc.ActionResult RenderPhoto(long userId)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RenderPhoto);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "userId", userId);
            RenderPhotoOverride(callInfo, userId);
            return callInfo;
        }
